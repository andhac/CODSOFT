...
function Navbar() {
    const icon = require('../../assets/Image/menu.png')
        ...
        <>
            <nav className="flex bg-white w-full items-center justify-between shadow-2xl p-4 h-16">
                ...
                <div>
                    ...
                    <a href="/signup" className="text-gray-950 p-4 transition-all delay-150 hover:text-xl">Browser job </a>
                    <div className="group inline-block relative">
                        <a href="/profile" className="text-gray-950 p-4 transition-all delay-150 hover:text-xl ">Companies</a>
                        <div
