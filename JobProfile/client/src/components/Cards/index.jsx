...
const Cards = () => {
    return (
        <>
            <div className="bg-blue-100 py-6 px-8 ">
                <div className='my-5  text-center'>
                    <h1 className='text-3xl text-center py-2' >Advantages of Using Three Jobs</h1>
                </div >
                <div className='mt-4  gap-6 flex w-full justify-center '>
                        ...
                        <div className=' p-5 '>
                            ...
                            <div className='text-center'>
                                <p className='text-gray-500 text-sm'>Unlock your potential with our non-accredited
                                    ...
                                    competitive job market or elevate your team's capabilities with these resources. We
                    ...
                    <div className='w-1/5 bg-white  border-blue-400 border-2 rounded-2xl'>
                        <div className=' p-5 '>
                            <div className='my-3 flex justify-center '>
                                <img src={exclusive} className='w-20'/>
                            </div>
                            <div className='text-center'>
                    ...
                    <div className='w-1/5 bg-white  border-blue-400 border-2 rounded-2xl'>
                        <div className=' p-5 '>
                            <div className='my-3 flex justify-center '>
                                <img src={headphone} className='w-20'/>
                            </div>
                            <div className='text-center'>
                    ...
                    <div className='w-1/5 bg-white border-blue-400 border-2 rounded-2xl'>
                        <div className=' p-5 '>
                            <div className='my-3 flex justify-center '>
                                <img src={comprehensive} className='w-20'/>
                            </div>
                            <div className='text-center'>
