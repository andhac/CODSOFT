...
function Hero() {
    ...
    const handleChange = (e) => {
        ...
        if (isSearchEmpty) setIsSearchEmpty(false); // Reset border color when user starts typing
    };
    ...
    return (
        <>
            <div className="inset-0 -z-10 h-full w-full bg-white bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem]">
                <div className="bottom-0 left-0 right-0 top-0 bg-[radial-gradient(circle_500px_at_50%_200px,#C9EBFF,transparent)]">
                    <div className="flex lg:w-full items-center mx-auto container">
                        <section className="flex flex-col items-center p-12 bg-transparent">
                            ...
                            <div className="flex space-x-3 mb-8">
                                <form onSubmit={handleSearch} className="form relative">
                                    ...
                                    <input
                                        className={classNames("w-52 input rounded-full px-8 py-3 border-2 focus:outline-none focus:border-blue-500 placeholder-gray-400 transition-all duration-300 shadow-md", {
                                            'border-red-500 bg-red-100': isSearchEmpty
                                        })}
                                ...
                                <button
                                    type='submit'
                                    className="ml-1 w-40 px-6 py-2 bg-[#479ced] text-white rounded-full active:bg-blue-700 transition-all duration-300 shadow-xl"
